    ...
    template: `
        ...
        >
            <pre 
                ...
                style="max-height: calc(100vh - 67px); scrollbar-width: thin; scrollbar-color: #18181b #000000;"
                v-html="highlighted"
            ></pre>
            <div 
                ...
                <textarea 
                    ...
                    v-model="editor"
                    @scroll="syncScroll" 
                    class="outline-none border-none focus:border-none focus:outline-none active:border-none text-transparent caret-white text-sm w-full h-screen font-mono resize-none overflow-auto whitespace-pre break-keep"
                    style="max-height: calc(100vh - 67px); scrollbar-width: thin; scrollbar-color: #18181b #000000;"
                ></textarea>
            </div>
        </div>
