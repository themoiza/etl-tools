            ...
            <div class="flex gap-4 items-top w-full">
                <div class="flex-none w-1/4">
                    <form class="max-w-sm" @submit.prevent="raFetch">
                        <label for="racoon" class="block text-sm">Table</label>
                        ...
                        <input id="for_ra_schema" v-model="ra_schema" type="text" placeholder="public" class="bg-gray-50 outline-none focus:outline-none text-white text-sxsm block w-full p-2 bg-gray-700 focus:bg-gray-700 placeholder-gray-400 text-white">

                        <label for="for_ra_table" class="block mt-4 text-sm">Table</label>
                        <input id="for_ra_table" v-model="ra_table" type="text" placeholder="table" class="bg-gray-50 outline-none focus:outline-none text-white text-xs block w-full p-2 bg-gray-700 focus:bg-gray-700 placeholder-gray-400 text-white">

                        <label for="for_ra_columns" class="block mt-4 text-sm">columns</label>
                        <input id="for_ra_columns" v-model="ra_columns" type="text" placeholder="id" class="bg-gray-50 outline-none focus:outline-none text-white text-xs block w-full p-2 bg-gray-900 focus:bg-gray-700 valid:bg-gray-700 placeholder-gray-400 text-white">
